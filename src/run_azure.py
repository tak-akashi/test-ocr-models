"""Script for running Azure Document Intelligence processing."""
...
def run_azure_timed_with_datetime(file_list, base_output_dir=None):
    """
    Run Azure Document Intelligence processing with timing and datetime-based output folders.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run Azure Document Intelligence processing")
    ...
    # Run Azure processing with timestamp-based output
    run_azure_timed_with_datetime(pdf_files, args.output_dir)
