"""Script for running Gemini 2.5 Flash document processing."""
...
def run_gemini_timed_with_datetime(file_list, base_output_dir=None):
    """
    Run Gemini processing with timing and datetime-based output folders.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run Gemini 2.5 Flash document processing")
    ...
    # Run Gemini processing with timestamp-based output
    run_gemini_timed_with_datetime(pdf_files, args.output_dir)
