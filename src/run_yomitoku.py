"""Script for running YOMITOKU document processing."""
...
def run_yomitoku_timed_with_datetime(file_list, base_output_dir=None):
    """
    Run YOMITOKU processing with timing and datetime-based output folders.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run YOMITOKU document processing")
    ...
    # Run YOMITOKU processing with timestamp-based output
    run_yomitoku_timed_with_datetime(pdf_files, args.output_dir)
